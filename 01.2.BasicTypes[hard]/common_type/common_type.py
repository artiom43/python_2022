def get_common_type(type1: type, type2: type) -> type:
    ...
    """
    list_of_types = [int, float, complex, str, list, tuple]
    list_elements_of_types = {bool: True, int: 1, float: 0.1, complex: 2j, list: [3, 2, 3], tuple: (1, ), str: "wer"}
    if type1 == range:
        type1 = tuple
    if type2 == range:
        type2 = tuple
